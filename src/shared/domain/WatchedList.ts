/**
 * @desc Para lista que precisam ser assitidas, caso uma regra de negócio possua essa especificação.
 * Por exemplo, "Se um item for removido do carrinho, marque ele como inativo", nesse caso, podemos pegar apenas o array de "removed" e persistir no banco
 */
